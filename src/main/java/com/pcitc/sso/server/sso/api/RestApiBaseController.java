package com.pcitc.sso.server.sso.api;
...
import com.pcitc.sso.server.uic.utils.ThreadContextUtil;
...
public abstract class RestApiBaseController extends SpringBeanAutowiringSupport {
    ...
    protected ResponseEntity createResponse(ErrorCodeEnum error) {
        return createResponse(error, null);
    }

    protected ResponseEntity createResponse(ErrorCodeEnum error, Object content) {
        ...
        return new ResponseEntity(result, headers, error.getHttpStatus());
    }
